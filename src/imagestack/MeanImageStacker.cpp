...
cv::Mat MeanImageStacker::stackImages(std::vector<cv::Mat> images){
	cout << "MeanImageStacker started..." << endl;
	...
	cv::Mat outImg(images[0].rows, images[0].cols, CV_64FC3);
	...
	outImg.convertTo(outImg, CV_8U, 1. / images.size());
